...
class DossierAssignCandidate ( models.TransientModel ) :
    ...
    match_basis = fields.Char ( string='Criterio' )  # basename que originó la coincidencia
...
class DossierAssignWizard ( models.TransientModel ) :
    ...
    def default_get(self, fields_list) :
        ...
        # coge id explícito si el botón lo pone en context; si no, usa active_id inyectado por Odoo
        ...
        # Poblar la tabla de sugerencias
        lines = []
